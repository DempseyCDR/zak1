...
export async function resetDb(): Promise<void> {
  await sql`TRUNCATE treasurer_report_audit, mapping_audit, non_dance_income, bookings, rate_parameter_audit, rate_parameters, performers, door_record_audit, gate_sales, door_records, attendance, quarterly_attendance_counts, events, event_groups, merge_audit, status_change_audit, memberships, payers, contact_emails, contacts RESTART IDENTITY CASCADE`;
